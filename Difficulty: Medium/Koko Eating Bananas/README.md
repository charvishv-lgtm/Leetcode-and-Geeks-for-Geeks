<h2><a href="https://www.geeksforgeeks.org/problems/koko-eating-bananas/1?_gl=1*33fsun*_up*MQ..*_gs*MQ..&gclid=Cj0KCQiAiebIBhDmARIsAE8PGNIxBtzrBMaujG74jvVS8rno89fNCsGDdjat6saZZi-AUV7s3pObAWsaAhzAEALw_wcB&gbraid=0AAAAAC9yBkBJ3_wLpmnHfdOpyQnwFQHHR">Koko Eating Bananas</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p data-start="120" data-end="259"><span style="font-size: 14pt;">Koko is given an array<strong> arr[],</strong> where each element represents a pile of bananas. She has exactly <strong>k</strong>&nbsp;hours to eat all the bananas.</span></p>
